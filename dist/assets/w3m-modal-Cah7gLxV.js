import{w as ve,s as fe,t as ge,v as be,M as g,y as se,R as l,i as v,r as P,a as f,x as a,z as K,e as ce,o as le,h as m,d as Y,j as ye,B as S,E as ie,O as E,C as q,D as oe,k as T,A as H,T as xe,F as Ce,b as ke,g as Se}from"./core-BtGtFV_K.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-BLXZ1Ftb.js";import"./index-6D060j6a.js";import"./index.es-CDS_84D4.js";import"./events-DQ172AOg.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return be(p,()=>r(p))},subscribeKey(r,e){return ge(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
